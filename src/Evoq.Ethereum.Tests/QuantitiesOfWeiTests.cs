...
{
    [TestClass]
    public class QuantitiesOfWeiTests
    {
        ...
        public void LocalCurrencyInWei_OneDollar_ReturnsCorrectWeiAmount()
        {
            ...
            BigInteger weiForOneDollar = QuantitiesOfWei.LocalCurrencyInWei(EtherPriceInUsd);
        ...
        {
            // Arrange
            BigInteger oneEther = QuantitiesOfWei.Ether;  // 10^18 wei

            // Act
            BigInteger usdValue = QuantitiesOfWei.WeiInLocalCurrency(EtherPriceInUsd, oneEther);
        ...
        {
            // Arrange
            BigInteger tenEther = QuantitiesOfWei.Ether * 10;  // 10 * 10^18 wei

            // Act
            BigInteger usdValue = QuantitiesOfWei.WeiInLocalCurrency(EtherPriceInUsd, tenEther);
        ...
        public void WeiInLocalCurrency_TransactionFee_ReturnsReasonableAmount()
        {
            ...
            // Act
            BigInteger usdValue = QuantitiesOfWei.WeiInLocalCurrency(EtherPriceInUsd, transactionFeeInWei);
        ...
        public void RoundTrip_ConversionIsConsistent()
        {
            ...
            // Act
            BigInteger weiAmount = QuantitiesOfWei.LocalCurrencyInWei(EtherPriceInUsd) * originalUsd;
            BigInteger roundTripUsd = QuantitiesOfWei.WeiInLocalCurrency(EtherPriceInUsd, weiAmount);
