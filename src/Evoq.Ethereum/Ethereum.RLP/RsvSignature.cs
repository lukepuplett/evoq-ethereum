...
public struct RsvSignature
{
    ...
    public RsvSignature(byte v, BigInteger r, BigInteger s)
    {
        V = v;
        R = r;
        S = s;
    ...
    public static RsvSignature FromRecoveryId(byte recoveryId, BigInteger r, BigInteger s, ulong chainId = 0)
    {
