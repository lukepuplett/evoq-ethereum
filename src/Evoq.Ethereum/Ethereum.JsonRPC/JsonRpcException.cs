...
/// </summary>
[Serializable]
public abstract class JsonRpcException : EthereumException
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="JsonRpcException"/> class with a specified error message and a reference to the inner exception that is the cause of this exception.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="JsonRpcException"/> class with serialized data.
    /// </summary>
